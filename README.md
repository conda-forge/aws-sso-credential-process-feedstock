About aws-sso-credential-process-feedstock
==========================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aws-sso-credential-process-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10943&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aws-sso-credential-process-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aws-sso-credential-process` can be installed with `conda`:
...
```
mamba install aws-sso-credential-process
```

It is possible to list all of the versions of `aws-sso-credential-process` available on your platform with `conda`:
...
```
mamba search aws-sso-credential-process --channel conda-forge
```
...
mamba repoquery search aws-sso-credential-process --channel conda-forge

# List packages depending on `aws-sso-credential-process`:
mamba repoquery whoneeds aws-sso-credential-process --channel conda-forge

# List dependencies of `aws-sso-credential-process`:
mamba repoquery depends aws-sso-credential-process --channel conda-forge
```
